...
DATASET_FIELDS: List[FieldDef] = [
    ...
    FieldDef('instrument_name',            'Instrument',    editable=False, verbose=False),
    FieldDef('instrument_id',              'Instrument ID', editable=False, verbose=False),
    FieldDef('project_id',                 'Project',       editable=False, verbose=False),
    FieldDef('timestamp',                  'Timestamp',     editable=True,  verbose=False),
    FieldDef('public',                     'Public',        editable=False, verbose=True),
...
SAMPLE_FIELDS: List[FieldDef] = [
    ...
    FieldDef('public',                     'Public',        editable=False, verbose=False),
    FieldDef('project_id',                 'Project',       editable=False, verbose=False),
    FieldDef('timestamp',                  'Timestamp',     editable=True,  verbose=False),
